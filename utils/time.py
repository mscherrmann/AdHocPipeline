...
def get_time_periods(start_date, end_date, period_length):
    ...
    along with a period length (in days). It then generates a list of
    time periods, each of a specified length. Each period is represented
    as a list containing two dates:the start and the end of the period.
    If the remaining days at the end of the range do not make up a full period,
    the last period is shortened accordingly.
    ...
    Returns:
    list of lists: A list where each element is a period represented by a
                   list of two dates:
    ...
    [["01.01.2020", "02.01.2020"], ["03.01.2020", "04.01.2020"],
     ["05.01.2020", "06.01.2020"], ["07.01.2020", "07.01.2020"]]
    """
